...
class Pass_Info_Update extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(window.$API_SERVER + "Passenger/" + PEmail, {
        headers: authHeader(),
      })
      .then((res) => {
        this.setState({
  ...
  UpdatePassenger() {
    ...
    axios
      .post(window.$API_SERVER + "Accounts/PassUpdate", obj, {
        headers: authHeader(),
      })
      ...
      <div class="card p-3 mt-5">
        <div class="card-body mt-5 ">
          ...
          <p class="text-dark text-center">
            Please fill in this form to update an account!
          </p>
          <div class="card-deck ">
            ...
            <div class="card bg-light text-dark w-50 p-3 ">
              <div class="card-body ">
                <form>
                  ...
                  <br></br>
                  <div class="form-inline">
                    <p class="col-lg-4 col-form-label">Confirm Password</p>
                    <p class=" h5">:</p>
                    <div class="col-lg-6">
                      <input
                        class="form"
